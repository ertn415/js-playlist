...
const setSong = (arrayIndex) => {
  ...
  audio.onloadeddata = () =>{
    maxDuration.innerText = timeFormatter(audio.duration)// sarkinin suresini dakika saniye cinsinden yazar.
  }
...
//ilerleme cubuguna dokundugunda
...
//durdura tikladiginda
pauseButton.addEventListener("click", pauseAudio);

//nexte tikladiginda
nextButton.addEventListener("click", nextSong);

//previousa tikladiginda
